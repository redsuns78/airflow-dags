...
args = {
    "project_id": "hello_world-0526083132",
}

dag = DAG(
    "hello_world-0526083132",
    default_args=args,
...
notebook_op_9426d557_d9d9_4c1a_98ef_e427c05a6ecf = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="hello_world-0526083132",
...
notebook_op_9426d557_d9d9_4c1a_98ef_e427c05a6ecf.image_pull_policy = "IfNotPresent"
